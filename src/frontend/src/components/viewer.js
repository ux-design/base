...
class Viewer extends Component {
  ...
  render() {
    ...
    if ( this.props.data.type === 'img' ) {
      content = <img src={ ip + '/images/' + this.props.data.url } style={{ width : '100%' , height : '100%' }} alt={ this.props.data.url }/>
    } 
    if ( this.props.data.type === 'video' ) {
      content = <img src={ ip + '/videos/' + this.props.data.url } style={{ width : '100%' , height : '100%' }} alt={ this.props.data.url }/>
    } 
    return (
