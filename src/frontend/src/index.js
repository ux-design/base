...
const update = ( page ) => {
    ...
    ReactDOM.render(<Block on data={ window.state.data } />, document.getElementById('block'));
    ...
    fetch(`http://${ip}:4000/templates/${page}`, {
        ...
        setTimeout( ()=>{
            ...
            ReactDOM.render(<Block data={ window.state.data } />, document.getElementById('block'));
